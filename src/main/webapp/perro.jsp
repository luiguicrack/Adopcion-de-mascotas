<%-- 
    Document   : perro
    Created on : 12/10/2023, 11:11:59 p. m.
    Author     : JORGE
--%>
    ...
    <body style="background: linear-gradient(to right, #a2ab58, #636363)">
        <div class="container text-center"></br>
            <form action="SvMascotaCan" method="POST">
                ...
                <button class="btn btn-success" onclick="alert('¡Se agrego el canino correctamente!')">Agregar</button>
                <h5></h5></br>
            </form>
        </div>
    </body>
